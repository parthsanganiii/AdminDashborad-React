...
const Car_detail = () => {
  return (
    <div className='bg-[#438FFE] dark:bg-[#242731] rounded-xl lg:h-[105vh] flex flex-col mx-auto lg:w-auto'>
      <div className='grid grid-cols-2 px-6 pt-8 gap-8'>
        {car_detail.map(deatils => (
          <div>
            <h4 className='text-[16px] font-medium text-[#C6DCFC]'>{deatils.title}</h4>
            <p className='text-[20px] font-bold text-[white]'>{deatils.desc}</p>
          </div>
        ))}
      </div>
