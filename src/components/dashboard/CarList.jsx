...
const data = [
    ...
    { id: 2, title: "Porsche 911 Carrera", img: "images/r-car-2.svg", percentage: "74% Recommend", bg: "bg-[#E3ECF1]", k: "130K", rent: "$28/h" },
    { id: 3, title: "Porsche 911 Carrera", img: "images/r-car-3.svg", percentage: "74% Recommend", bg: "bg-[#F4E3E5]", k: "130K", rent: "$28/h" },
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 w-full gap-8'>
            {
                data.map((item) => (
                    <div key={item.id}
                        ...
                        <img src={item.img} />
                        <h1 className='text-[#1F2128] font-bold text-[20px]'>{item.title}</h1>
